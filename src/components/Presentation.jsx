  ...
  return (
    ...
    >
      ...
      <p className="lg:leading-[1.25] sm:leading-[1.25] leading-[1.25] lg:text-6xl sm:text-4xl text-3xl dark:text-primaryBText text-primaryWText font-extrabold w-[70%] dark:selection:bg-bgWhite dark:selection:text-primaryWText selection:bg-bgBlack selection:text-primaryBText">
        ...
        <br />
        <span className="dark:text-primaryBButton text-primaryBButton dark:selection:text-Highlighted selection:text-primaryBButton">
          unforgettable
        </span>
      </p>
      ...
      <ul className="flex justify-between items-start w-[80%] lg:w-[45%] select-none">
        <li className="flex flex-col items-center justify-start gap-1 text-center text-secondaryBText">
          <span className="flex items-center gap-2 sm:text-3xl text-2xl font-bold dark:text-primaryBText text-primaryWText">
            +3
            <RocketIcon />
          </span>
      ...
      <div className="flex items-center gap-10 select-none">
        <a
          href="#contact"
          className="flex items-center justify-center gap-4 py-4 font-bold border-0 text-primaryWText w-fit bg-primaryBButton hover:opacity-90 px-7 rounded-2xl"
        >
        ...
        >
          <p className="whitespace-nowrap hidden sm:block lg:text-xl">
            Download CV
          </p>
          <DocumentIcon />
        </a>
