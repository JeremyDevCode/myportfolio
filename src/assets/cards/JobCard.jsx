    ...
    >
      ...
      <div className="flex flex-col justify-center">
        <div className="flex flex-col gap-2">
          ...
          <span className="dark:text-secondaryBText text-secondaryWText font-medium text-sm mt-1">
            {job.jobTime}
          </span>
        </div>
        <p className="dark:text-secondaryBText text-secondaryWText mt-5">
          {job.jobDescription}
        </p>
        <div
        ...
        >
          <div className="flex flex-col gap-2 mt-4">
            <h2 className="dark:text-primaryBText text-primaryWText font-bold">
              Activities
            </h2>
            <ul
              role="list"
              className={`${
                job.jobActivities && "pl-5"
          ...
          <div className="flex flex-col gap-2 mt-4">
            ...
            <ul className="flex flex-wrap gap-x-4 gap-y-2 mb-0">
              {job.jobTechnologies ? (
                job.jobTechnologies.map((technology) => (
